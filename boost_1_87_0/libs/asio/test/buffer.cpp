...
void test()
{
  ...
  BOOST_ASIO_CHECK(buffer_sequence_begin(b3) == b3.begin());
  BOOST_ASIO_CHECK(buffer_sequence_end(b3) == b3.end());
  ...
  BOOST_ASIO_CHECK(buffer_sequence_begin(b4) == b4.begin());
  BOOST_ASIO_CHECK(buffer_sequence_end(b4) == b4.end());
  ...
  BOOST_ASIO_CHECK(is_const_buffer_sequence<
      custom_const_buffer_sequence>::value);
  BOOST_ASIO_CHECK(!is_mutable_buffer_sequence<
      custom_const_buffer_sequence>::value);

  custom_const_buffer_sequence b11;
  BOOST_ASIO_CHECK(buffer_sequence_begin(b11) == &b11);
  BOOST_ASIO_CHECK(buffer_sequence_end(b11) == &b11 + 1);
  ...
  BOOST_ASIO_CHECK(buffer_sequence_begin(b12) == &b12);
  BOOST_ASIO_CHECK(buffer_sequence_end(b12) == &b12 + 1);
