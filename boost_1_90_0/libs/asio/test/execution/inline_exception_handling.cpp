...
void test_query()
{
  exec::inline_exception_handling_t result1 = boost::asio::query(Executor(), Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());

  Executor ex1 = {};
  exec::inline_exception_handling_t result2 = boost::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result2 == ExpectedResult());

  const Executor ex2 = {};
  exec::inline_exception_handling_t result3 = boost::asio::query(ex2, Param());
...
void test_constexpr_query()
{
  ...
  constexpr exec::inline_exception_handling_t result1 = boost::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());
}
...
void test_vars()
{
  BOOST_ASIO_CHECK(s() == exec::inline_exception_handling);
  BOOST_ASIO_CHECK(s() != exec::inline_exception_handling.propagate);
  BOOST_ASIO_CHECK(s() != exec::inline_exception_handling.capture);
  BOOST_ASIO_CHECK(s() != exec::inline_exception_handling.terminate);
  BOOST_ASIO_CHECK(n1() == exec::inline_exception_handling.propagate);
  BOOST_ASIO_CHECK(n1() != exec::inline_exception_handling.capture);
  BOOST_ASIO_CHECK(n1() != exec::inline_exception_handling.terminate);
  BOOST_ASIO_CHECK(n2() == exec::inline_exception_handling.capture);
  BOOST_ASIO_CHECK(n2() != exec::inline_exception_handling.propagate);
  BOOST_ASIO_CHECK(n2() != exec::inline_exception_handling.terminate);
  BOOST_ASIO_CHECK(n3() == exec::inline_exception_handling.terminate);
  BOOST_ASIO_CHECK(n3() != exec::inline_exception_handling.propagate);
  BOOST_ASIO_CHECK(n3() != exec::inline_exception_handling.capture);
}
